  ...
  return (
    <div>
      <div className="container">
        <div className="row text-center mb-5" style={{ marginTop: "10%" }}>
        ...
        <div className="row" style={{ marginTop: "10%" }}>
          <div
            className="col-6"
            style={{ lineHeight: "1.8", fontSize: "16px", paddingLeft: "18%" }}
          >
            <p>
          ...
          <div
            className="col-6"
            style={{ lineHeight: "1.8", fontSize: "16px", paddingRight: "18%" }}
          >
            <p>
